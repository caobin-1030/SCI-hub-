...
function Search(){
  ...
  var promise = $.get('http://oa.sangerbox.com/scihub',function(res){
    return res
  })
  promise.then(function(res){
    ...
    for(var i=0;i<res.length;i++){
        $("#list").find('p').eq(i).append("<img src="+res[i]+"/"+Math.random()+" width='1' height='1' onerror='autotest("+i+")' style='display:none'>");
    }
