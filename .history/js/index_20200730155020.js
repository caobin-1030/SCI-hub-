...
function Search(){
  if($('#input').val().indexOf('10.')==0 || $('#input').val().indexOf('https://doi.org/10')==0){
    ...
    $.post(`http://calculate.mysci.online:9000/pubmed/searchPubmedArticle/`,params,function(res){
      ...
      //         <tr>
      //           <td>标题：</td>
      //           <td>${JSON.stringify(res).res.articleList.searchData[0].title}</td>
      //         </tr>
      //         <tr>
      //           <td>DOI：</td>
      //           <td>${JSON.stringify(res).res.articleList.searchData[0].DOI}</td>
      //         </tr>
      //         <tr>
      //           <td>Journal：</td>
      //           <td>${JSON.stringify(res).res.articleList.searchData[0].journal.subName}</td>
      //         </tr>
      //         <tr>
      //           <td>下载通道1：</td>
      //           <td id="tongdao"></td>
