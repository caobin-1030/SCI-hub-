        ...
        $('#searchT').append(`
          <table class="table">
            <tbody>
              ...
              <tr>
                <td>下载通道2：</td>
                <td><a href="http://oa.sangerbox.com/dlscihub?tag=${$('#input').val()}" class="btn-sm btn-success" target="_blank">点击下载</a></td>
              </tr>
              <tr>
                <td>深度下载：</td>
        ...
        $('#searchT').append(`
          <table class="table">
            <tbody>
              ...
              <tr>
                <td>下载通道2：</td>
                <td><a href="http://oa.sangerbox.com/dlscihub?tag=${res[0][1]}" class="btn-sm btn-success" target="_blank">点击下载</a></td>
              </tr>
              <tr>
                <td>深度下载：</td>
                <td>(点击进入后，请点击页面左边的“SAVE”进行下载)</td>
